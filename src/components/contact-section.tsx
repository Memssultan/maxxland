      ...
      <div className="container px-4 sm:px-6 mx-auto">
        <div className="w-full max-w-[550px] mx-auto mb-6 md:mb-8">
          {onBack && (
            <Button 
              variant="outline" 
              className="w-full hover:bg-gray-100 transition-colors text-sm md:text-base font-slanty"
              onClick={onBack}
            >
              Скрыть контакты
            </Button>
        ...
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl md:text-3xl tracking-tighter sm:text-4xl md:text-5xl text-center mb-8 md:mb-12 text-red-700 font-slanty">
            Контакты
          </h2>
          <p className="text-base md:text-lg text-gray-600 mb-8 md:mb-12 text-center max-w-2xl mx-auto px-4 font-slanty">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 mb-8 md:mb-12">
            <Card className="p-4 md:p-6">
              <CardContent className="p-0">
                <h3 className="text-lg md:text-xl mb-4 text-red-700 font-slanty">Наши шоурумы</h3>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm md:text-base font-slanty">проспект Мангилик Ел 28</p>
                        <p className="text-gray-500 text-sm font-slanty">Showroom MaxxFine</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm md:text-base font-slanty">проспект Аль-Фараби, 103</p>
                        <p className="text-gray-500 text-sm font-slanty">Showroom MaxxFine</p>
                      </div>
                    </div>
                  </div>
            ...
            <Card className="p-4 md:p-6">
              <CardContent className="p-0">
                <h3 className="text-lg md:text-xl mb-4 text-red-700 font-slanty">Связаться с нами</h3>
                <div className="space-y-3 md:space-y-4">
                  <a href="tel:+77717689949" className="flex items-center space-x-3 p-2 hover:bg-gray-50 rounded-lg transition-colors">
                    ...
                    <span className="text-sm md:text-base font-slanty">+7 771 768 9949</span>
                  </a>
                  ...
                  <a href="mailto:infokerama@bk.ru" className="flex items-center space-x-3 p-2 hover:bg-gray-50 rounded-lg transition-colors">
                    ...
                    <span className="text-sm md:text-base font-slanty">infokerama@bk.ru</span>
                  </a>
                </div>
              </CardContent>
            </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 mb-8 md:mb-12">
            {/* Астана */}
            <Card className="p-1">
              <h3 className="text-lg mb-2 px-4 pt-2 text-red-700 font-slanty">Астана</h3>
            ...
            {/* Алматы */}
            <Card className="p-1">
              <h3 className="text-lg mb-2 px-4 pt-2 text-red-700 font-slanty">Алматы</h3>
              <div className="h-[170px] sm:h-[200px] md:h-[250px] w-full rounded-lg overflow-hidden">
