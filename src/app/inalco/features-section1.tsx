    ...
    <section className="py-6 sm:py-8 md:py-12 px-2 sm:px-4 bg-gradient-to-b from-background to-primary/5">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          Керамогранит INALCO — это флагманский продукт, задающий тренды. Он обладает высокой прочностью, устойчивостью к царапинам и механическим повреждениям, что позволяет использовать его на любых поверхностях. Универсальность коллекций INALCO делает его идеальным для интерьеров любого стиля.
          </p>
