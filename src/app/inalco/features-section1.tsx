    ...
    <section className="py-6 sm:py-8 md:py-12 px-2 sm:px-4 bg-gradient-to-b from-background to-primary/5">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          Мебель Inalco – воплощение инновационного дизайна в керамике. Каждое изделие – это безупречный синтез технологий MDi (Minerals, Design, innovation) и натуральных минералов, создающий уникальные поверхности с глубокой текстурой и потрясающей прочностью. Благодаря революционному подходу к обработке материалов, мебель Inalco сочетает в себе визуальную легкость и непревзойденную устойчивость к износу, что делает её идеальным выбором для современных интерьеров, где важны как эстетика, так и практичность.
          </p>
