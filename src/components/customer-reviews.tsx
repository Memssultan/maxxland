...
export function CustomerReviews() {
  ...
  return (
    <section className="w-full py-6 md:py-12 lg:py-20 bg-gray-50">
      ...
      <h2 className="text-xl md:text-3xl lg:text-4xl tracking-tighter text-center mb-6 md:mb-12 text-red-700 font-slanty">Отзывы наших клиентов</h2>
              ...
              >
                <CardContent className="p-4">
                  <div className="flex items-center space-x-3 mb-3">
                    ...
                    <div>
                      <h3 className="text-sm font-slanty">{review.name}</h3>
                      <div className="flex">
                        {[...Array(5)].map((_, i) => (
                          <Star
                            key={i}
                  ...
                  <p className="text-gray-600 text-sm mb-4 line-clamp-4 font-slanty">{review.review}</p>
                  <div className="flex items-center text-gray-400 text-xs mt-4 pt-3 border-t font-slanty">
            ...
            <Card key={review.id} className="transition-shadow hover:shadow-lg">
              <CardContent className="p-6">
                <div className="flex items-center space-x-4 mb-4">
                  ...
                  <div>
                    <h3 className="text-base font-slanty">{review.name}</h3>
                    <div className="flex">
                      {[...Array(5)].map((_, i) => (
                        <Star
                          key={i}
                ...
                <p className="text-gray-600 text-base mb-4 font-slanty">{review.review}</p>
                <div className="flex items-center text-gray-400 text-sm mt-4 pt-3 border-t font-slanty">
