  ...
  return (
    <header className="px-4 lg:px-6 h-14 flex items-center justify-between fixed top-0 left-0 right-0 bg-white z-50 shadow-sm">
          ...
          <NavigationMenuList className="flex items-center gap-2">
            ...
            <NavigationMenuItem>
              ...
              >
                <Button 
                  variant="ghost"
                  className="hover:bg-gray-100 text-[#25D366] rounded-full px-6 border-none shadow-none font-medium"
                >
                  WhatsApp
                </Button>
              </Link>
            ...
            <NavigationMenuItem>
              ...
              >
                <Button 
                  variant="ghost"
                  className="hover:bg-gray-100 text-[#E4405F] rounded-full px-6 border-none shadow-none font-medium"
                >
                  Instagram
                </Button>
              </Link>
      ...
      <div className="flex items-center gap-2 lg:hidden">
        ...
        {/* Mobile Menu Button */}
        <Button variant="ghost" className="ml-2" onClick={() => setIsOpen(!isOpen)}>
          {isOpen ? <X /> : <Menu />}
        </Button>
      </div>
          ...
          <nav className="flex flex-col p-4">
            ...
            <div className="mt-4 space-y-2">
              ...
              >
                <Button 
                  variant="ghost"
                  className="w-full hover:bg-gray-100 text-pink-500 flex items-center gap-2 justify-start px-3"
                >
