    ...
    <section className="py-6 sm:py-8 md:py-12 px-2 sm:px-4 bg-gradient-to-b from-background to-primary/5">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          FMG — лидер среди итальянских брендов керамогранита, сочетающий элегантность и инновации. Уникальный состав материала обеспечивает прочность, устойчивость к царапинам и способность пропускать свет, создавая эффектные визуальные решения. Выбирая FMG, вы получаете долговечный материал с непревзойденным итальянским качеством.
          </p>
