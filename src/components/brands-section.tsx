    ...
    <section id="brands" className="py-8 sm:py-12 md:py-16 bg-background">
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center mb-8 sm:mb-12">
          <h2 className="text-2xl sm:text-3xl md:text-4xl text-center text-primary mb-4 font-helvoni">Наши бренды</h2>
          <p className="text-sm sm:text-base text-muted-foreground text-center max-w-2xl font-helvoni">
        ...
        {brands.length > INITIAL_DISPLAY_COUNT && (
          <div className="flex justify-center mt-8">
            <Button
              ...
              className="flex items-center gap-2 font-helvoni"
            >
              {showAll ? (
                <>
                  Скрыть
