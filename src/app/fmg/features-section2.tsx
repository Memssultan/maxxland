    ...
    <section className="py-6 sm:py-8 md:py-12 px-2 sm:px-4 bg-gradient-to-b from-background to-primary/5">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          FMG – это воплощение роскошного минимализма в современной мебели. В основе коллекций лежит благородный мрамор, который мастерски сочетается с элементами из полированной латуни и натурального дерева. Каждый предмет мебели становится настоящим произведением искусства, где природные узоры камня создают неповторимый рисунок, а безупречное качество исполнения подчеркивает статус и изысканный вкус владельца.
          </p>
